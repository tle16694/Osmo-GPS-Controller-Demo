...
* 如需参考 Demo 的代码实现，请先完整阅读 [项目 README 文档](../README_CN.md)，熟悉硬件连线图和代码结构，然后查看 `connect_logic.c` 文件。
...
首先，请详细阅读 [本项目的常见问题与解答](./Q&A_CN.md)，确认遇到的问题是否已有对应解决方案。
...
[本项目的常见问题与解答](./Q&A_CN.md)：解答开发过程中可能遇到的一些常见问题
